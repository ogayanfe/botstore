...
function ErrorPage() {
    ...
    return (
        <div className="w-full h-full max-h-full flex-col gap-4 errorElement flex items-center p-5 bg-gray-50 text-gray-900 justify-center dark:text-blue-500 dark:bg-[#141517]">
